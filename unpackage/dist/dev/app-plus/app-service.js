...
var render = function() {
  ...
  return _c("view", [
    ...
    _c(
      "view",
      {
        staticClass: _vm._$s(20, "sc", "flex justify-between p-3"),
        attrs: { _i: 20 }
      },
      [_c("text", { attrs: { _i: 21 }, on: { click: _vm.logout } })]
    ),
    _c(
      "view",
      {
        staticClass: _vm._$s(22, "sc", "flex justify-between p-3"),
        attrs: { _i: 22 }
      },
      [_c("text", { attrs: { _i: 23 }, on: { click: _vm.logout } })]
    ),
    _c(
      "view",
      {
        staticClass: _vm._$s(24, "sc", "flex justify-between p-3"),
        attrs: { _i: 24 }
      },
      [_c("text", { attrs: { _i: 25 }, on: { click: _vm.logout } })]
    ),
    _c(
      "view",
      {
        staticClass: _vm._$s(26, "sc", "flex justify-between p-3"),
        attrs: { _i: 26 }
      },
      [_c("text", { attrs: { _i: 27 }, on: { click: _vm.logout } })]
    ),
    _c(
      "view",
      {
        staticClass: _vm._$s(28, "sc", "flex justify-between p-3"),
        attrs: { _i: 28 }
      },
      [_c("text", { attrs: { _i: 29 }, on: { click: _vm.logout } })]
    )
  ])
}
var recyclableRender = false
